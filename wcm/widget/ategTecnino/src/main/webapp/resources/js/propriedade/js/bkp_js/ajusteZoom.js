...
zoomSpanDisplay = function(input, type) {
    if (type == 'hide') {
        ...
        $(input).parent('div.input-group.fs-full-width').find('div.bootstrap-tagsinput').find('span.fluig-typeahead > input.tt-input').css('width', '250px');
    }
};
